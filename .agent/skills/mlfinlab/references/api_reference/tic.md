# API Reference: tic.py

**Language**: Python

**Source**: `portfolio_optimization/tic.py`
...
##### tic_correlation(self, tree_struct, corr_matrix, tn_relation, kde_bwidth = 0.01)
...
##### _get_linkage_corr(self, tree_struct, corr_matrix)
...
##### _link_clusters(global_linkage, local_linkage, global_elements, grouped_elements)
...
| grouped_elements | None | - | - |


##### _update_dist(distance_matrix, global_linkage, local_linkage_tr, global_elements, criterion = None)
...
| global_linkage | None | - | - |
| local_linkage_tr | None | - | - |
| global_elements | None | - | - |
| criterion | None | None | - |


##### _get_atoms(linkage, element)
...
##### _link2corr(self, linkage, element_index)
