...
**Source**: `codependence/correlation.py`

---

## Functions

### angular_distance(x: np.array, y: np.array) → float
...
### absolute_angular_distance(x: np.array, y: np.array) → float
...
### squared_angular_distance(x: np.array, y: np.array) → float
...
### distance_correlation(x: np.array, y: np.array) → float
