# API Reference: encoding.py

**Language**: Python

**Source**: `microstructural_features/encoding.py`
...
|------|------|---------|-------------|
| tick_rule_array | list | - | - |

**Returns**: `str`



### _get_ascii_table() → list
...
### _find_nearest(array: list, value: float) → float
...
### _get_letter_from_encoding(value: float, encoding_dict: dict) → str
