# API Reference: onc.py

**Language**: Python

**Source**: `clustering/onc.py`

---

## Functions

### _improve_clusters(corr_mat: pd.DataFrame, clusters: dict, top_clusters: dict) → Union[pd.DataFrame, dict, pd.Series]
...
**Returns**: `Union[pd.DataFrame, dict, pd.Series]`



### _cluster_kmeans_base(corr_mat: pd.DataFrame, max_num_clusters: int = 10, repeat: int = 10) → Union[pd.DataFrame, dict, pd.Series]
...
### _check_improve_clusters(new_tstat_mean: float, mean_redo_tstat: float, old_cluster: tuple, new_cluster: tuple) → tuple
...
| Name | Type | Default | Description |
|------|------|---------|-------------|
| new_tstat_mean | float | - | - |
| mean_redo_tstat | float | - | - |
| old_cluster | tuple | - | - |
| new_cluster | tuple | - | - |
...
### cluster_kmeans_top(corr_mat: pd.DataFrame, repeat: int = 10) → Union[pd.DataFrame, dict, pd.Series, bool]
...
**Returns**: `Union[pd.DataFrame, dict, pd.Series, bool]`



### get_onc_clusters(corr_mat: pd.DataFrame, repeat: int = 10) → Union[pd.DataFrame, dict, pd.Series]
