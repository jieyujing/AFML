# API Reference: olmar.py

**Language**: Python

**Source**: `online_portfolio_selection/olmar.py`
...
##### __init__(self, reversion_method, epsilon, window = None, alpha = None)
...
##### _calculate_rolling_moving_average(self)
