...
##### __init__(self, input_cols: Union[Sequence[str], str], output_cols: Union[Sequence[str], str])
...
|------|------|---------|-------------|
| self | None | - | - |
| input_cols | Union[Sequence[str], str] | - | - |
| output_cols | Union[Sequence[str], str] | - | - |


##### __call__(self, x: pd.DataFrame) → Union[pd.Series, tuple[pd.Series, ...]]

Apply the transformation to input data using the specified computational backend.
...
##### output_name(self) → Union[str, list[str]]
...
**Inherits from**: BaseTransform, ABC
...
Apply the transformation using the specified computational backend.
...
##### _check_datetime_index(x: pd.DataFrame) → bool
...
##### _get_timestamps(self, x: pd.DataFrame) → NDArray[np.int64]
...
##### _prepare_input_nb(self, x: pd.DataFrame) → Union[dict[str, NDArray], NDArray]
...
**Returns**: `Union[dict[str, NDArray], NDArray]`


##### _prepare_output_nb(self, idx: pd.Index, y: Union[NDArray, tuple[NDArray]]) → Union[pd.Series, tuple[pd.Series, ...]]
...
| self | None | - | - |
| idx | pd.Index | - | - |
| y | Union[NDArray, tuple[NDArray]] | - | - |

**Returns**: `Union[pd.Series, tuple[pd.Series, ...]]`


##### _pd(self, x: Union[pd.DataFrame, pd.Series]) → Union[pd.Series, tuple[pd.Series]]
...
##### _nb(self, x: Union[pd.DataFrame, pd.Series]) → Union[pd.Series, tuple[pd.Series]]
...
**Inherits from**: CoreTransform, ABC

#### Methods

##### __init__(self, input_col: str, output_col: str)
...
##### _prepare_input_nb(self, x: pd.DataFrame) → NDArray
...
##### _prepare_output_nb(self, idx: pd.Index, y: NDArray) → pd.Series
...
##### __init__(self, input_cols: Sequence[str], output_col: str)
...
##### _prepare_input_nb(self, x: pd.DataFrame) → dict[str, NDArray]
...
##### __init__(self, input_col: str, output_cols: Sequence[str])
...
##### _prepare_output_nb(self, idx: pd.Index, y: tuple[NDArray, ...]) → tuple[pd.Series, ...]
...
##### __init__(self, input_cols: Sequence[str], output_cols: Sequence[str])
...
##### __init__(self, left: BaseTransform, right: BaseTransform, op_name: str, op_func: Callable)
...
##### __init__(self, transform: BaseTransform, constant: float, op_name: str, op_func: Callable)
...
##### __init__(self, transform: BaseTransform, op_name: str, op_func: Callable)
