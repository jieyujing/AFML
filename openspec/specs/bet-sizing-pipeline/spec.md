# Bet Sizing Pipeline Specification

## Purpose
TBD: To map Meta-Model probabilities to target portfolio allocations, averaging overlapping bets and applying step-size discretizations to minimize execution friction.
