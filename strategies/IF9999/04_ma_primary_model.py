"""
04_ma_primary_model.py - IF9999 MA Primary Model 回测 (TBM 版本)
...
def compute_tbm_labels(
    ...
    # TBM 参数
    profit_loss_barriers = config.get('profit_loss_barriers', (2.0, 2.0))
    ...
    print(f"   止盈止损乘数 (tp_mult, sl_mult): {profit_loss_barriers}")
...
def main():
    """IF9999 MA Primary Model Backtest (TBM) 主流程."""
    print("=" * 70)
    print("  IF9999 MA Primary Model Backtest (TBM)")
    print("=" * 70)
