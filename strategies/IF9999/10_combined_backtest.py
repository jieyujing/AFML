"""
10_combined_backtest.py - IF9999 组合策略真实回测
...
def main():
    logger.info("=" * 60)
    logger.info("  IF9999 Primary + Meta Combined Backtest")
    logger.info("=" * 60)
    ...
    # PnL 多曲线对比
    plt.plot(price_bh.index, price_bh.values, label='Benchmark: Buy & Hold (IF9999)', color='#555555', alpha=0.3, linestyle=(0, (3, 5, 1, 5)))
    ...
    plt.title("IF9999 Strategy Cumulative PnL: In-Sample vs Out-of-Sample Comparison", fontsize=15, fontweight='bold')
