# API Reference: risk_estimators.py

**Language**: Python

**Source**: `portfolio_optimization/risk_estimators.py`
...
##### minimum_covariance_determinant(returns, price_data = False, assume_centered = False, support_fraction = None, random_state = None)
...
|------|------|---------|-------------|
| returns | None | - | - |
| price_data | None | False | - |
| assume_centered | None | False | - |
| support_fraction | None | None | - |
| random_state | None | None | - |


##### empirical_covariance(returns, price_data = False, assume_centered = False)
...
##### shrinked_covariance(returns, price_data = False, shrinkage_type = 'basic', assume_centered = False, basic_shrinkage = 0.1)
...
| returns | None | - | - |
| price_data | None | False | - |
| shrinkage_type | None | 'basic' | - |
| assume_centered | None | False | - |
| basic_shrinkage | None | 0.1 | - |


##### semi_covariance(returns, price_data = False, threshold_return = 0)
...
| returns | None | - | - |
| price_data | None | False | - |
| threshold_return | None | 0 | - |


##### exponential_covariance(returns, price_data = False, window_span = 60)
...
##### denoise_covariance(self, cov, tn_relation, denoise_method = 'const_resid_eigen', detone = False, market_component = 1, kde_bwidth = 0.01, alpha = 0)
...
| cov | None | - | - |
| tn_relation | None | - | - |
| denoise_method | None | 'const_resid_eigen' | - |
| detone | None | False | - |
| market_component | None | 1 | - |
| kde_bwidth | None | 0.01 | - |
| alpha | None | 0 | - |
...
##### _fit_kde(observations, kde_bwidth = 0.01, kde_kernel = 'gaussian', eval_points = None)
...
| observations | None | - | - |
| kde_bwidth | None | 0.01 | - |
| kde_kernel | None | 'gaussian' | - |
| eval_points | None | None | - |


##### _mp_pdf(var, tn_relation, num_points)
...
##### _pdf_fit(self, var, eigen_observations, tn_relation, kde_bwidth, num_points = 1000)
...
| self | None | - | - |
| var | None | - | - |
| eigen_observations | None | - | - |
| tn_relation | None | - | - |
| kde_bwidth | None | - | - |
| num_points | None | 1000 | - |


##### _find_max_eval(self, eigen_observations, tn_relation, kde_bwidth)
...
##### _denoised_corr(self, eigenvalues, eigenvectors, num_facts)
...
##### _denoised_corr_targ_shrink(eigenvalues, eigenvectors, num_facts, alpha = 0)
...
##### _detoned_corr(self, corr, eigenvalues, eigenvectors, num_facts, market_component = 1)
