# API Reference: importance.py

**Language**: Python

**Source**: `feature_importance/importance.py`
...
| model | None | - | - |
| feature_names | None | - | - |
| clustered_subsets | None | None | - |

**Returns**: (none)



### mean_decrease_accuracy(model, X, y, cv_gen, clustered_subsets = None, sample_weight_train = None, sample_weight_score = None, scoring = log_loss, random_state = 42)
...
| cv_gen | None | - | - |
| clustered_subsets | None | None | - |
| sample_weight_train | None | None | - |
| sample_weight_score | None | None | - |
| scoring | None | log_loss | - |
...
### single_feature_importance(clf, X, y, cv_gen, sample_weight_train = None, sample_weight_score = None, scoring = log_loss)
