# API Reference: matrix_flags.py

**Language**: Python

**Source**: `labeling/matrix_flags.py`
...
##### __init__(self, prices, window, template_name = None)
...
##### _transform_data(self, row_num, window = 30)
...
##### _apply_template_to_matrix(self, matrix, template)
...
##### apply_labeling_matrix(self, threshold = None)
