# API Reference: mean_variance.py

**Language**: Python

**Source**: `portfolio_optimization/mean_variance.py`
...
##### __init__(self, calculate_expected_returns = 'mean', risk_free_rate = 0.03)
...
| risk_free_rate | None | 0.03 | - |


##### allocate(self, asset_names = None, asset_prices = None, expected_asset_returns = None, covariance_matrix = None, solution = 'inverse_variance', target_return = 0.2, target_risk = 0.01, risk_aversion = 10, weight_bounds = None)
...
| solution | None | 'inverse_variance' | - |
| target_return | None | 0.2 | - |
| target_risk | None | 0.01 | - |
| risk_aversion | None | 10 | - |
| weight_bounds | None | None | - |


##### allocate_custom_objective(self, non_cvxpy_variables, cvxpy_variables, objective_function, constraints = None)
...
|------|------|---------|-------------|
| self | None | - | - |
| non_cvxpy_variables | None | - | - |
| cvxpy_variables | None | - | - |
| objective_function | None | - | - |
| constraints | None | None | - |


##### get_portfolio_metrics(self)
...
##### plot_efficient_frontier(self, covariance, expected_asset_returns, min_return = 0, max_return = 0.4, risk_free_rate = 0.05)
...
| min_return | None | 0 | - |
| max_return | None | 0.4 | - |
| risk_free_rate | None | 0.05 | - |


##### _error_checks(self, asset_names, asset_prices, expected_asset_returns, covariance_matrix, solution = None)
...
##### _calculate_estimators(self, asset_prices, expected_asset_returns, covariance_matrix)
...
##### _inverse_variance(self, covariance, expected_returns)
...
##### _min_volatility(self, covariance, expected_returns)
...
##### _max_return_min_volatility(self, covariance, expected_returns, risk_aversion)
...
##### _max_sharpe(self, covariance, expected_returns)
...
##### _min_volatility_for_target_return(self, covariance, expected_returns, target_return)
...
##### _max_return_for_target_risk(self, covariance, expected_returns, target_risk)
...
##### _max_diversification(self, covariance, expected_returns)
...
##### _max_decorrelation(self, covariance, expected_returns)
