# API Reference: bet_sizing.py

**Language**: Python

**Source**: `bet_sizing/bet_sizing.py`
...
| market_price | None | - | - |
| forecast_price | None | - | - |
| cal_divergence | None | 10 | - |
| cal_bet_size | None | 0.95 | - |
| func | None | 'sigmoid' | - |
