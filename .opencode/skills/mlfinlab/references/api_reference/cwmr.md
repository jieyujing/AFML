# API Reference: cwmr.py

**Language**: Python

**Source**: `online_portfolio_selection/cwmr.py`
...
##### __init__(self, confidence, epsilon, method = 'var')
...
##### _calculate_lambd(self, new_m, new_v, new_w, mean_x)
