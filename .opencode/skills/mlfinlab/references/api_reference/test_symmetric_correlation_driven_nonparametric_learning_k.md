# API Reference: test_symmetric_correlation_driven_nonparametric_learning_k.py

**Language**: Python

**Source**: `tests/test_symmetric_correlation_driven_nonparametric_learning_k.py`

---

## Classes

### TestSymmetricCorrelationDrivenNonparametricLearningK
...
##### test_scorn_k_window_error(self)
