# API Reference: tail_sets.py

**Language**: Python

**Source**: `labeling/tail_sets.py`
...
##### __init__(self, prices, n_bins, vol_adj = None, window = None)
