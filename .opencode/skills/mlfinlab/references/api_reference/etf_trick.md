# API Reference: etf_trick.py

**Language**: Python

**Source**: `multi_product/etf_trick.py`
...
##### __init__(self, open_df, close_df, alloc_df, costs_df, rates_df = None, index_col = 0)
...
##### _append_previous_rows(self, cache)
...
##### generate_trick_components(self, cache = None)
...
##### _get_batch_from_csv(self, batch_size)
...
##### _rewind_etf_trick(self, alloc_df, etf_series)
...
##### _csv_file_etf_series(self, batch_size)
...
##### get_etf_series(self, batch_size = 100000.0)
...
### get_futures_roll_series(data_df, open_col, close_col, sec_col, current_sec_col, roll_backward = False, method = 'absolute')
...
| close_col | None | - | - |
| sec_col | None | - | - |
| current_sec_col | None | - | - |
| roll_backward | None | False | - |
| method | None | 'absolute' | - |
