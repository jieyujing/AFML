# API Reference: returns_estimators.py

**Language**: Python

**Source**: `portfolio_optimization/returns_estimators.py`
...
##### calculate_mean_historical_returns(asset_prices, resample_by = None, frequency = 252)
...
##### calculate_exponential_historical_returns(asset_prices, resample_by = None, frequency = 252, span = 500)
...
##### calculate_returns(asset_prices, resample_by = None)
