# API Reference: labeling.py

**Language**: Python

**Source**: `labeling/labeling.py`

---

## Functions

### apply_pt_sl_on_t1(close, events, pt_sl, molecule)
...
| min_ret | None | - | - |
| num_threads | None | - | - |
| vertical_barrier_times | None | False | - |
| side_prediction | None | None | - |
| verbose | None | True | - |
