# API Reference: second_generation.py

**Language**: Python

**Source**: `microstructural_features/second_generation.py`

---

## Functions

### get_bar_based_kyle_lambda(close: pd.Series, volume: pd.Series, window: int = 20) → pd.Series
...
### get_bar_based_amihud_lambda(close: pd.Series, dollar_volume: pd.Series, window: int = 20) → pd.Series
...
### get_bar_based_hasbrouck_lambda(close: pd.Series, dollar_volume: pd.Series, window: int = 20) → pd.Series
...
### get_trades_based_kyle_lambda(price_diff: list, volume: list, aggressor_flags: list) → List[float]
...
| price_diff | list | - | - |
| volume | list | - | - |
| aggressor_flags | list | - | - |

**Returns**: `List[float]`



### get_trades_based_amihud_lambda(log_ret: list, dollar_volume: list) → List[float]
...
### get_trades_based_hasbrouck_lambda(log_ret: list, dollar_volume: list, aggressor_flags: list) → List[float]
