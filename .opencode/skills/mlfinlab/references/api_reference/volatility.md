...
### get_parksinson_vol(high: pd.Series, low: pd.Series, window: int = 20) → pd.Series
...
### get_garman_class_vol(open: pd.Series, high: pd.Series, low: pd.Series, close: pd.Series, window: int = 20) → pd.Series
...
### get_yang_zhang_vol(open: pd.Series, high: pd.Series, low: pd.Series, close: pd.Series, window: int = 20) → pd.Series
