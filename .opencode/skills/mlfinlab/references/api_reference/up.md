...
**Source**: `online_portfolio_selection/up.py`
...
##### __init__(self, number_of_experts, weighted = 'hist_performance', k = 1)
...
|------|------|---------|-------------|
| self | None | - | - |
| number_of_experts | None | - | - |
| weighted | None | 'hist_performance' | - |
| k | None | 1 | - |
...
##### _calculate_weights_on_experts(self)
...
##### _generate_simplex(self, number_of_experts, number_of_assets)
