...
**Source**: `online_portfolio_selection/base.py`
...
##### allocate(self, asset_prices, weights = None, resample_by = None, verbose = False)
...
##### _calculate_portfolio_returns(self, all_weights, relative_return)
...
##### _optimize(self, optimize_array, solver = cp.SCS)
...
##### _round_weights(self, threshold = 1e-06)
...
|------|------|---------|-------------|
| self | None | - | - |
| threshold | None | 1e-06 | - |


##### _uniform_weight(self)
...
##### _print_progress(self, iteration, prefix = '', suffix = '', decimals = 1, bar_length = 50)
...
##### _calculate_relative_return(asset_prices)
...
##### _check_asset(asset_prices, weights)
