# API Reference: ef3m.py

**Language**: Python

**Source**: `bet_sizing/ef3m.py`
...
##### __init__(self, moments, epsilon = 10 ** (-5), factor = 5, n_runs = 1, variant = 1, max_iter = 100000, num_workers = -1)
...
##### get_moments(self, parameters, return_result = False)
...
| self | None | - | - |
| parameters | None | - | - |
| return_result | None | False | - |


##### iter_4(self, mu_2, p_1)
...
##### single_fit_loop(self, epsilon = 0)
...
### iter_4_jit(mu_2, p_1, m_1, m_2, m_3, m_4)
...
### iter_5_jit(mu_2, p_1, m_1, m_2, m_3, m_4, m_5)
