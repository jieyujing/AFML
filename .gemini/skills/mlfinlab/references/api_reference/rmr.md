# API Reference: rmr.py

**Language**: Python

**Source**: `online_portfolio_selection/rmr.py`
...
##### __init__(self, epsilon, n_iteration, window, tau = 0.001)
...
##### _calculate_predicted_relatives(self, time)
...
##### _transform(old_mu, price_window)
