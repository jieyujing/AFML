# API Reference: nco.py

**Language**: Python

**Source**: `portfolio_optimization/nco.py`
...
##### allocate_nco(self, cov, mu_vec = None, max_num_clusters = None, n_init = 10)
...
| cov | None | - | - |
| mu_vec | None | None | - |
| max_num_clusters | None | None | - |
| n_init | None | 10 | - |


##### allocate_mcos(self, mu_vec, cov, num_obs, num_sims = 100, kde_bwidth = 0.01, min_var_portf = True, lw_shrinkage = False)
...
| min_var_portf | None | True | - |
| lw_shrinkage | None | False | - |


##### estim_errors_mcos(self, w_cvo, w_nco, mu_vec, cov, min_var_portf = True)
...
##### _simulate_covariance(mu_vector, cov_matrix, num_obs, lw_shrinkage = False)
...
##### _cluster_kmeans_base(corr, max_num_clusters = None, n_init = 10)
...
##### _form_block_matrix(num_blocks, block_size, block_corr)
...
##### form_true_matrix(self, num_blocks, block_size, block_corr, std = None)
